...
public class FpDual {
	...
	/** Declaración de un objeto de la clase Scanner, definido como estático */
	...
	private static void variablesChallenge() {
		...
		String job, names, option;
			...
			if (job.equals("programador")) {
				...
				System.out.println("\t");
				System.out.println("El número de vacaciones que tiene el empleado " + d1.getNameOfEmployee()
						+ ", son de : " + d1.getDaysOfVacations() + " días");
				System.out.println("El número de vacaciones que tiene el empleado " + d2.getNameOfEmployee()
						+ ", son de : " + d2j + " días");
				System.out.println("El número de vacaciones que tiene el empleado " + d3.getNameOfEmployee()
						+ ", son de : " + d3.getDaysOfVacations() + " días");
				System.out.println("El número de vacaciones que tiene el empleado " + d4.getNameOfEmployee()
						+ ", son de : " + d4.getDaysOfVacations() + " días");
